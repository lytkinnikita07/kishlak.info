  ...
  function initVideoPlayers() {
    ...
    videoWrappers.forEach((wrapper, index) => {
      ...
      overlay.addEventListener("click", () => {
        ...
        iframe.src = videoSrc + "?autoplay=1&controls=1&rel=0&showinfo=1"
        overlay.style.display = "none"
      })

      // Add parameters to prevent autoplay and improve appearance
      if (iframe.src.indexOf("?") === -1) {
        iframe.src = iframe.src + "?autoplay=0&controls=1&rel=0&showinfo=1"
      } else {
        iframe.src = iframe.src + "&autoplay=0&controls=1&rel=0&showinfo=1"
      }
    })
